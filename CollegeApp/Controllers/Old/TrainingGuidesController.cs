...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public ActionResult Create([Bind(Include = "TrainingGuideId,TermId,MajorId,UserId,TraineeName,TraineeNumber,ProgramTypeId,DiscussingTheTrainingPlan,ReasonsForFailureInTraining,Notes")] TrainingGuide trainingGuide)
//        {
//            if (ModelState.IsValid)
//            {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public ActionResult Edit([Bind(Include = "TrainingGuideId,TermId,MajorId,UserId,TraineeName,TraineeNumber,ProgramTypeId,DiscussingTheTrainingPlan,ReasonsForFailureInTraining,Notes")] TrainingGuide trainingGuide)
//        {
//            if (ModelState.IsValid)
//            {
//                var getTrainingGuideIdData = db.TrainingGuides.Where(x => x.TrainingGuideId == trainingGuide.TrainingGuideId).FirstOrDefault();
//                getTrainingGuideIdData.DiscussingTheTrainingPlan = trainingGuide.DiscussingTheTrainingPlan;
//                getTrainingGuideIdData.ReasonsForFailureInTraining = trainingGuide.ReasonsForFailureInTraining;
